...
// Anti-raid için gerekli cache'ler
client.joinCache = new Map();      // Son katılımları takip
client.raidMode = new Map();        // Raid modu aktif mi
client.captchaCache = new Map();    // CAPTCHA bekleyenler

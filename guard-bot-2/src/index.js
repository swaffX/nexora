...
// Anti-spam için cache'ler
client.messageCache = new Map();     // Kullanıcı mesaj geçmişi
client.warnedUsers = new Map();       // Uyarılan kullanıcılar
client.mutedUsers = new Map();        // Susturulan kullanıcılar
